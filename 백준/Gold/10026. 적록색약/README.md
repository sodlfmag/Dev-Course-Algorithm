...
-   일반사람들이 보는 구역과 적록색약 사람들이 보는 구역을 따로 구하기
-   적록색약 사람들이 보는 구역을 세기 위해 R과 G를 하나로 통일
-   상, 하, 좌, 우 확인하여 같은 색이라면 재귀함수 호출하여 방문처리 하기
-   적록색약 사람들이 보는 색 구역 세기 전 방문처리 배열 초기화
